...
# list = ['1', '2', '3', 'smotri']
# print(list)
# list = [1, 2, 3, 'smotri', '4']     # Python - язык с динамической типизацией, то есть мы можем миксовать различные типы в одном списке, и python сам определяет какой тип использовать для данной переменной (что влияет на производительность, поэтому япы со статической типизацией производительнее и более предпочтительны, но это не точно)
# print(list)
